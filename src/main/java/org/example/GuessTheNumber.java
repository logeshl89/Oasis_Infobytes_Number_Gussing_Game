...
public class GuessTheNumber {
    public static void main(String[] args) {
        ...
        do {
            min = Integer.parseInt(JOptionPane.showInputDialog(null, "Enter the minimum value of the range:"));
            max = Integer.parseInt(JOptionPane.showInputDialog(null, "Enter the maximum value of the range:"));
